...
def user_dashboard(request):
    ...
    return render(request, 'pages/user-dashboard.html', {'username': username})
...
def job_list(request):
    username = request.session.get('username', 'User')
    return render(request, 'pages/job-list.html', {'username': username})

def job_details(request):
    username = request.session.get('username', 'User')
    return render(request, 'pages/job-details.html', {'username': username})

def company_dashboard(request): 
    username = request.session.get('username', 'Company')
    return render(request, 'pages/company-dashboard.html', {'username': username})

def company_jobs(request):
    username = request.session.get('username', 'Company')
    return render(request, 'pages/company-jobs.html', {'username': username})

def add_job(request):   
    username = request.session.get('username', 'Company')
    return render(request, 'pages/add-job.html', {'username': username})

def edit_job(request):   
    username = request.session.get('username', 'Company')
    return render(request, 'pages/edit-job.html', {'username': username})
